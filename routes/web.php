...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // TRANSACTION ROUTES
    Route::get('transaction', [BookingController::class, 'getAllBookings'])->name('transaction.index');
    Route::post('transaction/{room}/void', [BookingController::class, 'voidBooking'])->name('transaction.void');

    // TRANSACTION ROUTES
    Route::get('report', [ReportController::class, 'indexReport'])->name('report.index');
    Route::post('report/sales', [ReportController::class, 'salesReport'])->name('report.sales');
});
